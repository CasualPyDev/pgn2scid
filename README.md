...
**IMPORTANT: The latest 1.6.1 release of pgn2scid uses a different version checker which causes older releases to crash! PLEASE UPDATE YOUR VERSION by downloading the 1.6.1 release!**
