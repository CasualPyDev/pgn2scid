...
For Mac users there's now a very convenient way to use pgn2scid. Thanks to Kayvan Sylvan there's a Docker container available which enables you to use pgn2scid without installing Python or any other dependencies which would otherwise be necessary. If you are unfamiliar with the concepts of Docker software containers you can get some information on https://www.docker.com/what-docker
